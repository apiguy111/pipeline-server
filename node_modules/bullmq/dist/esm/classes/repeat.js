...
export class Repeat extends QueueBase {
    ...
    async updateRepeatableJob(name, data, opts, { override }) {
        ...
        if (nextMillis) {
            ...
            let repeatJobKey;
            if (override) {
                repeatJobKey = await this.scripts.addRepeatableJob((_b = opts.repeat.key) !== null && _b !== void 0 ? _b : this.hash(repeatConcatOptions), nextMillis, {
                    name,
                ...
                repeatJobKey = await this.scripts.updateRepeatableJobMillis(client, (_c = opts.repeat.key) !== null && _c !== void 0 ? _c : this.hash(repeatConcatOptions), nextMillis, repeatConcatOptions);
            }
            if (repeatJobKey) {
